    ...
    return (
      <div id="ourServices">
        <Row className="d-flex justify-content-center serv">
          ...
          <Col md={5} className="serviceContainer" style={{ padding: 0 }}>
            ...
            <div className="serviceli">
              <img className="serviceItem" src={ficheck} alt="check"></img> Sewa
            ...
            <div className="serviceli">
              <img className="serviceItem" src={ficheck} alt="check"></img>{" "}
